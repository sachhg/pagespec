...
export async function startWatch(url: string, options: { onChange?: string, format?: string, depth?: string, tokens?: string }) {
    ...
    let previousSnapshot: PageSnapshot | null = null;
    let isProcessing = false;

    async function processChange(triggerFile?: string) {
        ...
        try {
            ...
            if (previousSnapshot) {
                ...
                console.log(formatOutput(diffResult, format as any));
            } else {
